...
Чтобы добавить новый html-темплейт, создайте новый html-файл в папке ___templates___, например about.html. Затем в файле webpack.common.js добавьте еще один инстанс HTML Webpack Plugin с новыми настройками
```javascript
plugins: [
new HtmlWebpackPlugin({
			filename: "index.html",
